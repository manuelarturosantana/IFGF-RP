...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        for (int i = 0; i < n_iters; i++) {
            ...
            // std::complex<double> k (9.355812111042747,0);
            // std::complex<double> k((1 << (i + 2)) * M_PI, 0.0);
            // Exterior eigenvalue frequency
            // std::complex<double> k(-0.86602540378444, -1.5);
            std::complex<double> k(-0.86713540378444, -1.51);
            // std::complex<double> k(-0.74602540378444, -1.5);
