...
inline void parametrization_q(const double s, const double t, const int patch, double& x, double& y, double& z)
{
...
inline void cartesian_product_q(const double s, const double t, const int patch, double& nx, double& ny, double& nz) 
{
...
inline double jacobian_q(const double s, const double t, const int patch)
{

    double nx, ny, nz;

    cartesian_product_q(s, t, patch, nx, ny, nz); 
...
inline void normal_q(const double s, const double t, const int patch, double& nx, double& ny, double& nz) 
{
...
inline void dxds_q(const double s, const double t, const int patch, double& dxdsx, double& dxdsy, double& dxdsz) 
{
...
inline void dxdt_q(const double s, const double t, const int patch, double& dxdtx, double& dxdty, double& dxdtz) 
{
...
inline void dxdsds_q(const double s, const double t, const int patch, double& dxdsdsx, double& dxdsdsy, double& dxdsdsz) 
{
...
inline void dxdtdt_q(const double s, const double t, const int patch, double& dxdtdtx, double& dxdtdty, double& dxdtdtz) 
{
...
inline void dxdsdt_q(const double s, const double t, const int patch, double& dxdsdtx, double& dxdsdty, double& dxdsdtz) 
{
