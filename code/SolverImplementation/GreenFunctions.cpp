...
inline void Solver::HH2(const double p1x, const double p1y, const double p1z,
         const double p2x, const double p2y, const double p2z,
         const double nx, const double ny, const double nz,
...
inline void Solver::HH_far(const double xVers_0, const double xVers_1, const double xVers_2,
